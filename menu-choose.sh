...
# menu-choose.sh
# ---------------------------------------------
# Двохрежимний інструмент вибору з TUI-меню:
# 1) source-режим (бібліотека):   source menu_choose.sh; menu_choose items=ARR outvar=VAR ...
# 2) exec-режим (CLI-утиліта):     menu-choose.sh [опції] [--] item1 item2 ...
#
# Особливості:
...
#
# ПРИМІТКА: передавати items як items_ref можливо ЛИШЕ в source-режимі.
# ---------------------------------------------
